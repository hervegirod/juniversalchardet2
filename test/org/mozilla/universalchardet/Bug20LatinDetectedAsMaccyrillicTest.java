...
public class Bug20LatinDetectedAsMaccyrillicTest {
   ...
   public void testFile() throws IOException {
      ...
      String originalEncoding = UniversalDetector.detectCharsetEnum(testFile);
   ...
   public void testLatin() throws IOException {
      ...
      detector.dataEnd();
      Assert.assertEquals("WINDOWS-1252", detector.getDetectedCharsetEnum());
   ...
   public void testUTF8() {
      ...
      detector.dataEnd();
      Assert.assertEquals("UTF-8", detector.getDetectedCharsetEnum());
